...
namespace NorthStandard.Testing.ScreenPlayFramework.Infrastructure.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCoreScreenPlayFramework(this IServiceCollection services)
        {
            services
                .AddScopedImplementingFromAssembly<IContext>(typeof(ServiceCollectionExtensions).Assembly)
                .AddScopedImplementingFromAssembly<IOrchestrator>(typeof(ServiceCollectionExtensions).Assembly)
                .AddScopedImplementingFromAssembly<IActor>(typeof(ServiceCollectionExtensions).Assembly)
                .AddScopedImplementingFromAssembly<IValidator>(typeof(ServiceCollectionExtensions).Assembly);
        ...
        /// <param name="from"><see cref="Assembly"/> to find types in</param>
        /// <returns>The <see cref="IServiceCollection"/></returns>
        public static IServiceCollection AddScreenPlayFrameworkFromAssembly(this IServiceCollection services, Assembly from)
        {
            services
                .AddScopedImplementingFromAssembly<IContext>(from)
                .AddScopedImplementingFromAssembly<IOrchestrator>(from)
                .AddScopedImplementingFromAssembly<IActor>(from)
                .AddScopedImplementingFromAssembly<IPage>(from)
                .AddScopedImplementingFromAssembly<IValidator>(from);
